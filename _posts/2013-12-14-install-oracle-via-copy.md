...
прописыванием соответствующих переменных среды.
...
[swap-file]: {% post_url 2012-10-06-installing-oracle-xe-11gr2-on-centos-6 %}
[shm]: {% post_url 2013-06-11-increasing-memory-of-oracle-xe %}
...
[firewall]: {% post_url 2013-01-11-centos-63-minimal-from-zero-to-useful-environment %}#firewall
