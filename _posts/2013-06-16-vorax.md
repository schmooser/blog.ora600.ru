...
[Vorax][vorax] is a plugin for vim which turns it to full-featured Oracle IDE
...
First of all, I tried to use [homebrew][homebrew] as OS X package manager.
It's very simple and useful. Go use it.

I also switched from bash to zsh. At the first time I used [oh-my-zsh][ohmyzsh]
as the set of extensions. Then I switched to [yadr][yadr] which brings a lot of
...
[Vorax4-beta][vorax4-beta] and it doesn't have all features for now, so I use
...
[homebrew]: mxcl.github.io/homebrew/
